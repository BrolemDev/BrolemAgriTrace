...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Oficinas y Roles /</span> Lista Oficinas
        </h4>
                    ...
                    <form class="pt-0" id="eCommerceCategoryListForm" enctype="multipart/form-data"
                        ...
                        <div class="form-floating form-floating-outline mb-4">
                            <input type="text" class="form-control" id="ecommerce-category-title"
                                placeholder="Ingresa nombre de oficina" name="categoryTitle" aria-label="category title">
                            <label for="ecommerce-category-title" data-i18n="Office"></label>
                        </div>
...
@section('scripts')
    <!-- Page JS -->
    <script src="{{ asset('js/app-ecommerce-office-list.js') }}"></script>
@endsection
