                        ...
                        <form id="branchForm" class="row g-4" onsubmit="return false">
                            ...
                            <div class="col-12 col-md-8">
                                <div class="form-floating form-floating-outline">
                                    ...
                                    <label for="name">Nombre de Sucursal/Almacén</label>
                                </div>
                            </div>
...
@section('scripts')
    <script src="{{ asset('js/app-branch-list.js') }}"></script>
@endsection
